...
object ComputeFeatures {
  ...
  def computeGamesFeatureGroup(spark: SparkSession, log: Logger, datasetPath: String, jobId: Int): Unit = {
  ...
  def computeSeasonScoresFeatureGroup(spark: SparkSession, log: Logger, datasetPath: String, jobId: Int): Unit = {
  ...
  def computeAttendanceFeatureGroup(spark: SparkSession, log: Logger, datasetPath: String, jobId: Int): Unit = {
  ...
  def computePlayersFeatureGroup(spark: SparkSession, log: Logger, datasetPath: String, jobId: Int): Unit = {
  ...
  def computeTeamsFeatureGroup(spark: SparkSession, log: Logger, datasetPath: String, jobId: Int): Unit = {
